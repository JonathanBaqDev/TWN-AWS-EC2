...
Reference project: https://github.com/techworld-with-nana/react-nodejs-example

Example of deploying applications to an Amazon Elastic Compute Cloud (EC2) instance and AWS CLI usage for EC2 and IAM.
